...
export const socialChannels = ['Instagram', 'TikTok', 'YouTube', 'Twitter', 'Facebook', 'LinkedIn'];

export const contentTypesBySocial = {
  Instagram: ['Posts', 'Reels', 'Stories', 'IGTV'],
  TikTok: ['Videos', 'Live Streams'],
  YouTube: ['Videos', 'Shorts', 'Live Streams'],
  Twitter: ['Tweets', 'Threads', 'Spaces'],
  Facebook: ['Posts', 'Videos', 'Stories', 'Live Videos'],
...
export const travelNiches = [
  ...
  'Hotel Reviews', 'Flight Reviews', 'Travel Gear', 'Travel Photography'
];
