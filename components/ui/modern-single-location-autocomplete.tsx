...
interface SingleLocationAutocompleteProps {
  value: string;
...
const ModernSingleLocationAutocomplete = ({
  value,
  onChange,
  placeholder = "Enter your location..."
}: SingleLocationAutocompleteProps) => {
...
export default ModernSingleLocationAutocomplete;